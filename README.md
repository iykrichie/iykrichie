...
> **Building secure and impactful artificial intelligence and data systems for regulated industries.** <br/>
...
| :--- | :--- |
| **🤖 Enterprise AI Architecture** | Local Language Model Orchestration, Retrieval Augmented Generation, Agentic Systems (Ollama, LlamaIndex) |
| **💻 Software Engineering** | TypeScript, Node.js, Python, React (Next.js/Vite), WebSockets, Application Programming Interfaces |
